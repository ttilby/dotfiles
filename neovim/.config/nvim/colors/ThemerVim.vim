  ...
  let s:guishade0 = "#1a1a1b"
  let s:guishade1 = "#383839"
  let s:guishade2 = "#565657"
  let s:guishade3 = "#747475"
  let s:guishade4 = "#939194"
  let s:guishade5 = "#b1afb2"
  let s:guishade6 = "#cfcdd0"
  let s:guishade7 = "#edebee"
  let s:guiaccent0 = "#c65967"
  let s:guiaccent1 = "#d3873b"
  let s:guiaccent2 = "#e5be31"
  let s:guiaccent3 = "#97b55a"
  let s:guiaccent4 = "#76a377"
  let s:guiaccent5 = "#6484b5"
  let s:guiaccent6 = "#995785"
  let s:guiaccent7 = "#ac7155"
  ...
  exec "hi Function guifg=".s:guiaccent2
  exec "hi Function ctermfg=".s:ctermaccent2
